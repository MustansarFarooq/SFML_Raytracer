 ...
 *
 * A realtime adaptation of the book.
 */
...
void spheres(hittable_list &world) {
    ...
    auto material1 = std::make_shared<dielectric>(1.5);
    world.add(std::make_shared<sphere>(sf::Vector3f(0, 1, -1), 0.4f, material1));

    auto material2 = std::make_shared<lambertian>(sf::Vector3f(0.85, 0.06, 0.8));
    world.add(std::make_shared<sphere>(sf::Vector3f(-1, 1, -1), 0.4f, material2));

    auto material3 = std::make_shared<metal>(sf::Vector3f(0.05f, 0.55f, 0.2f), 0.0f);
    world.add(std::make_shared<sphere>(sf::Vector3f(1, 1, -1), 0.4f, material3));
}
...
void light(hittable_list &world) {
    ...
    world.add(std::make_shared<quad>(sf::Vector3f(0.5, 1, -1), sf::Vector3f(0, 0, 1), sf::Vector3f(0, 1, 0),
                                     material2));

    auto material3 = std::make_shared<metal>(sf::Vector3f(0.8, 0.8, 0.8), 0);
    world.add(std::make_shared<quad>(sf::Vector3f(-0.5, 1, -1), sf::Vector3f(0, 0, 0.5), sf::Vector3f(0, 0.5, 0),
                                     material3));
}
...
void quadsAndSphere(hittable_list &world) {
    ...
    world.add(std::make_shared<quad>(sf::Vector3f(0.5, 1, -1), sf::Vector3f(0, 0, 3), sf::Vector3f(0, 1, 0),
                                     material2));
}
...
int main() {
    ...
    //world stuff
    hittable_list world;
    auto groundMaterial = std::make_shared<checkerTexture>(1.f, sf::Vector3f(0.65, 0.65, 0.65),
                                                           sf::Vector3f(0.2, 0.2, 0.2));
    world.add(std::make_shared<class sphere>(sf::Vector3f(0, -1000, -1), 1000,
                                             std::make_shared<lambertian>(groundMaterial)));
